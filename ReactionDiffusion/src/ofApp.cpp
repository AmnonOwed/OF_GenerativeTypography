...
void ofApp::setup(){
	...
	rd.setup(320, 180); // setup the simulation with the specified width and height
...
void ofApp::update(){
	...
	// get the result of the simulation into an image
	result = rd.getImage(fg_color, bg_color);
